...
<tr><td style='text-align:right'>Enter Keyword : </td><td>"; echo "<input type='text' name='keyword'></input>"; echo "</td></tr>
</table>
<br/>
...
echo "</table>";
echo "<br/>";
	echo "<a class='button black' href='eventskey.php'>GO BACK</a>";
}
?>
