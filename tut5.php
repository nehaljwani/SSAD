...
{
	$g=$_POST[$k];
	if($g==="Delete" or $g==="Edit" or $g==="Add a Tutorial")
	{
		break;
	}
}
...
if($g==="Edit")
{
	...
	while($row=mysql_fetch_array($sql))
	{
		if($k===$i)
		{
			...
			$z14=$row['Room'];
			$z15=$row['PrevRoom'];
			mysql_query("delete from Rooms where Code='$b' and Day='$z11' and StartTime='$z12' and EndTime='$z13' and Room='$z14'");
		}
		$flag=1;
		$i++;
	}
...
//		echo "</table>";
	...
	echo "
		...
		<br><br><input type='submit' value='Check Rooms'>";
}
if($g==="Add a Tutorial")
{
	echo "
